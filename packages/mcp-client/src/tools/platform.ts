...
const TOOL_CATALOG = [
  ...
  { module: "screening", tools: ["list_screening_profiles", "get_screening_profile", "create_screening_profile", "update_screening_profile", "delete_screening_profile", "run_screen", "get_screen_results", "create_instruments_from_screening", "get_available_kpis", "get_screening_classifications", "get_universe", "update_universe_entry", "list_intersection_configs", "create_intersection_config", "get_intersection_config", "update_intersection_config", "delete_intersection_config", "run_intersection", "list_intersection_runs", "get_intersection_run", "get_intersection_diff"] },
