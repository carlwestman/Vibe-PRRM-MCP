...
const TOOL_CATALOG = [
  ...
  { module: "portfolio", tools: ["register_trade", "get_positions", "get_position", "get_trade_history", "get_portfolio_summary", "get_allocation", "get_fx_exposure", "update_trade", "delete_trade"] },
